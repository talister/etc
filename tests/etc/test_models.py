...
class TestSite:
    ...
    def test_combined_fits_file_newer_version(self):
        test_config = {
            "name": "Cerro Armazones",
            "altitude": 3060,
            "latitude": -24.58916667,
            "longitude": -70.19166667,
            "transmission": files("tests.etc.data").joinpath("test_skytable_v209.fits").as_posix(),
            "radiance": files("tests.etc.data").joinpath("test_skytable_v209.fits").as_posix(),
        }
        site = Site(**test_config)
